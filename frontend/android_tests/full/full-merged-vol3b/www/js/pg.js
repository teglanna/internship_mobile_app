    ...
    $.fn.pgwSlideshow = function(options) {
        ...
        var setup = function() {
            ...
            pgwSlideshow.plugin.find('.ps-list > ul > li').each(function() {
                ...
                //$('<li class="elt_' + elementId + '"></li>').wrapInner("<div class='show-image'></div>");
                // Set element in the current list
                var currentElement = $('<li class="elt_' + elementId + '"></li>');

                //'<div class="show-image"><img src="' + element.image + '" alt="' + (element.title ? element.title : '') + '"><input type="image" src="img/del2.png" /></div>'
...
*/
               ...
               /* elementContainer.find('input').css({
                    display:'block',
                    position: 'absolute'
                });*/
